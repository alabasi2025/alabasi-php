            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-plus-circle"></i> إضافة نوع حساب جديد
                    </h3>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="3"
                                      placeholder="وصف اختياري لنوع الحساب...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
